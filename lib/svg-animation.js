    ...
    this.shadowRoot.innerHTML = `
      ...
      <div class="floating-elements">
        <svg width="400" height="400" viewBox="0 0 400 400" xmlns="http://www.w3.org/2000/svg">
          ...
          <image class="wiggle-image" href="${image1Src}" x="325" y="175" />
          <image class="wiggle-image" style="animation-delay: -0.5s;" href="${image2Src}" x="100" y="305" />
          <image class="wiggle-image" style="animation-delay: -1s;" href="${image3Src}" x="100" y="45" />
        </svg>
      </div>
    `;
  }
